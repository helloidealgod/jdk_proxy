...
/*Stmt*/        {"pop;push 0,E;", "pop;push 0,Funcall,{aSeg};", "pop;push 0,Typ,{aTyp},Nadef,{aSeg};", "pop;push 0,for,(,ForstList,semi,E,semi,ForetList,),Block;", "pop;push 0,while,(,E,),Block;", "pop;push 0,do,Block,while,(,E,),semi;", "pop;push 0,If,Else';", "error", "pop;push 0,E;", "error", "error", "error", "pop;push 0,E;", "error", "error", "error", "error", "error", "error", "error", "pop;push 0,E;", "error", "error", "error", "error", "error", "pop;push 0,Block;", "pop;", "error"},
...
/*Nadef*/       {"error", "pop;push 1,eq,=,Na,{aNa},=,E,{aE},semi;push 1,ne,=,Na,{aNa3},Tempdef',semi", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error"},
