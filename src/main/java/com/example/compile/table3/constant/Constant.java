...
/*Stmt*/        {"pop;push 0,E;", "pop;push 0,Funcall;", "pop;push 0,Typ,Nadef;", "pop;push 0,for,(,{for(},ForstList,semi,{endForstList},E,semi,{endE},ForetList,),{endForetList},Block,{endForBlock};", "pop;push 0,while,(,E,),Block;", "pop;push 0,do,Block,while,(,E,),semi;", "pop;push 0,If,Else';", "error", "pop;push 0,E;", "error", "error", "error", "pop;push 0,E;", "error", "error", "error", "error", "error", "error", "error", "pop;push 0,E;", "error", "error", "error", "error", "error", "pop;push 0,Block;", "pop;", "error"},
