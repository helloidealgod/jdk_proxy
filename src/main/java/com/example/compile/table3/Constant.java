...
/*Ef*/          {"pop;push 0,E,{aE1},Et'", "pop;push 0,E,{aE1},Et'", "error", "error", "error", "error", "error", "error", "pop;push 0,E,{aE1},Et'", "error", "error", "error", "pop;push 0,E,{aE1},Et'", "error", "error", "error", "error", "error", "error", "error", "pop;push 0,E,{aE1},Et'", "error", "error", "error", "error", "error", "error", "error", "error"},
...
/*id*/          {"pop;push 0,consv,{aConsv}", "pop;push 1,eq,(,Na,{aFna},(,EList,),{aFcall};push 1,ne,(,Na,{aNa2}", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error", "error"},
